...
import UseContext from "./Components/Products";
  ...
  return (
    <>
      <div>
        ...
        <div
          className="container-fluid h-10  d-flex justify-content-evenly align-items-center p-3 mt-1"
          style={{
            backgroundColor: "rgb(178, 222, 240)",
            color: "black",
            borderRadius: "20px",
